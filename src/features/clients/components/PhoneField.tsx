...
const PhoneInput =
  (PhoneInputImport as unknown as { default?: typeof PhoneInputImport })
...
export function PhoneField({
  ...
  return (
    <FormField
      ...
      required={required}
      error={error}
      className={cn('relative z-30 overflow-visible', className)}
    >
      <PhoneInput
        country="at"
        value={value}
        ...
        containerClass={cn('phone-field')}
        dropdownClass="phone-field-dropdown"
        searchClass="phone-field-search"
