...
import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, FormField, Input, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, } from '@/components/ui';
      ...
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)} noValidate>
        <Card className="relative z-20 overflow-visible">
          ...
          <CardContent className="grid gap-4 overflow-visible sm:grid-cols-2">
            ...
            <FormField label="Status" htmlFor="client-status" required error={errors.status?.message}>
